...
namespace battle
{
    public partial class PixelHumanoid
    {
        ...
        public class SkillFactory : StaticGetter<SkillFactory>, IOnStaticFound
        {
            ...
            // do nothing
            private State s_noneSkill = new State()
            {
            ...
            private static int s_lightingPillarSkillDamage = 1; // TODO: load from scriptable object maybe?
            private State s_lightingPillarSkill = new State()
            {
                OnEnter = (PixelHumanoid owner) =>
                {
                    owner.stats.mp = 0;
